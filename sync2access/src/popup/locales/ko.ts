export default {
  ...
  shareCreation: { title: '공유 생성 완료!', message: '{{domain}}에서 {{count}}개 쿠키 공유됨', createAnother: '새로 만들기' },
  ...
  copyUrlButton: { label: '복사', copied: '복사됨!' },
  ...
  clearCookies: { label: '쿠키 삭제', success: '✓ {{count}}개 쿠키 삭제됨 (클립보드에 복사됨)' },
};
